...
<div class="container position-relative slide1">
  <img src="<?php echo G5_THEME_IMG_URL?>/LL.png" alt="" class="prev d-none d-md-block" >
  <img src="<?php echo G5_THEME_IMG_URL?>/RR.png" alt="" class="next d-none d-md-block">
...
<div class="container position-relative slide2">
    ...
    <div class="slickslide2">
        <?php
            echo latest('theme/pic_yong', 'gallery', 7, 23);		
        ?>
    </div>
</div>
